        ...
        <section className="flex max-w-[80%] mx-auto justify-between">
          <div className="mt-[1rem]">
            ...
            <p className="max-w-[30rem]">
              ...
              accusantium. Perspiciatis ipsa temporibus, dolore nihil facere
              omnis tenetur voluptate quam totam doloremque facilis doloribus
              aliquam dignissimos? Tenetur quo explicabo harum qui? Quam
              pariatur dolor repellendus doloremque.
            </p>
          </div>
